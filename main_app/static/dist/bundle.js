...
var ConnectFour = function (_Component) {
  _inherits(ConnectFour, _Component);

  function ConnectFour(props) {
    _classCallCheck(this, ConnectFour);

    var _this = _possibleConstructorReturn(this, (ConnectFour.__proto__ || Object.getPrototypeOf(ConnectFour)).call(this, props));
  ...
  _createClass(ConnectFour, [{
    ...
    value: function login(username, password) {
      ...
      _axios2.default.get(uri, user).then(function (response) {
    ...
    value: function signup(username, password) {
      ...
      var uri = "/create-user";
      var user = { username: username, password: password };
      _axios2.default.post(uri, user).then(function (response) {
    ...
    value: function onClickSubmit(username, password) {
      var submit = this.state.session === 'login' ? this.login : this.signup;
    ...
    value: function render() {
      ...
      var sessionProps = {
        state: this.state,
        submitSession: function submitSession(username, password) {
          return _this4.onClickSubmit(username, password);
        }
      };

      var component = this.state.loggedIn ? _react2.default.createElement(_game2.default, null) : _react2.default.createElement(_session2.default, { state: this.state, submitSession: this.onClickSubmit });
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  _reactDom2.default.render(_react2.default.createElement(ConnectFour, null), root);
});
...
var Game = function (_Component) {
  ...
  function Game(props) {
    ...
    _this.handlePlacement = _this.handlePlacement.bind(_this);
  ...
  _createClass(Game, [{
    key: 'handlePlacement',
    value: function handlePlacement(event) {
      var _this2 = this;

      var columnId = parseInt(event.target.id);
    ...
    key: 'checkDirectionColor',
    value: function checkDirectionColor(currentSlot, direction) {
      // Get adjacent coordinates
      var adjSlot = currentSlot.slice(0);
      ...
      var adjColor = this.state.board[adjSlot[0]][adjSlot[1]];
      if (color === adjColor) {
        return true;
      } else {
        return false;
    ...
    value: function displayBoard() {
      ...
      return this.state.board.map(function (row, i) {
        rowElements = row.map(function (column, j) {
          var color = void 0;
          if (column === 'red') {
            color = redPlayer;
          } else if (column === 'blue') {
          ...
          return _react2.default.createElement('button', { key: j, id: j,
    ...
    key: 'statusDisplay',
    value: function statusDisplay() {
      var display = void 0;
      if (this.state.isGameWon) {
        var winner = this.state.currentPlayer === 'red' ? 'Blue' : 'Red';
        ...
        display = _react2.default.createElement(
          ...
          null,
          'It is ',
          this.state.currentPlayer.toUpperCase(),
          ' Player\'s Turn'
        );
      }
    ...
    value: function resetButton() {
      return _react2.default.createElement(
        'button',
        { className: 'reset', onClick: this.handleReset },
        'RESET'
      );
    }
  }, {
...
var Session = function (_React$Component) {
  ...
  _createClass(Session, [{
    ...
    key: 'onChangeInput',
    value: function onChangeInput(type) {
      var _this2 = this;
